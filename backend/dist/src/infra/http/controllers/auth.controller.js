...
const get_current_user_use_case_1 = require("../../../core/use-cases/auth/get-current-user.use-case");
...
let AuthController = class AuthController {
    ...
    async login(body) {
        ...
        return {
            user: user_presenter_1.UserPresenter.toHTTP(result.user),
            token: result.token,
    ...
    async me(req) {
        ...
        return { user: user_presenter_1.UserPresenter.toHTTP(user) };
    }
};
